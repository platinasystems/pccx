...
archive_mode = on
                                # (change requires restart)
#archive_command = 'test ! -f /var/lib/postgresql/wals/%f && cp %p /var/lib/postgresql/wals/%f'
archive_command = 'gzip < %p > /var/lib/postgresql/wals/%f'
...
log_truncate_on_rotation = on           # If on, an existing log file with the
                                        ...
                                        # in all cases.
log_rotation_age = 1440 # -> 24h        # Automatic rotation of logfiles will
